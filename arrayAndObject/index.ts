...
// Big O of Object Method >>  Object.keys: O(N) 키의 갯수 / Object.values: O(N) 밸류의 갯수 / Object.entries : O(N) 키밸류의 갯수 / hasOwnProperty: O(1)ㅌㅌㅌㅌㅌㅌㅊㅊㅊㅊㅊㅊㅊㅊㅊㅊㅊㅊㅊㅊㅊㅊㅊㅊㅊㅊㅊㅊㅊㅊㅊㅊㅊㅊㅊㅊㅊㅊㅊㅊㅊㅊㅊㅊㅊㅊ

// <배열>
// 순서가있고, 정렬하기위해서 사용한다.
// 성능에서 손해를 볼 수 있다. 벼열에서 인덱스를 알고 찾아가는것은 O(1) ㅣ찾기 O(N),
